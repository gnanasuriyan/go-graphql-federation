...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "ProductList.data":
		if e.complexity.ProductList.Data == nil {
			break
		}

		return e.complexity.ProductList.Data(childComplexity), true
...
var sources = []*ast.Source{
	{Name: "graph/schema.graphqls", Input: `type Product @key(fields: "id"){
  id: Int!
  name: String!
  price: Float!
}
...
extend type Query {
  topProducts(first: Int = 5): ProductList!
}
...
func (ec *executionContext) _Entity_findProductByID(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNProduct2ᚖgithubᚗcomᚋgnanasuriyanᚋgoᚑgraphqlᚋproductᚑmicroᚑserviceᚋgraphᚋmodelᚐProduct(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Mutation_createProduct(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().CreateProduct(rctx, args["name"].(string), args["price"].(float64))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _ProductList_data(ctx context.Context, field graphql.CollectedField, obj *model.ProductList) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
	...
	res := resTmp.([]*model.Product)
	fc.Result = res
	return ec.marshalNProduct2ᚕᚖgithubᚗcomᚋgnanasuriyanᚋgoᚑgraphqlᚋproductᚑmicroᚑserviceᚋgraphᚋmodelᚐProductᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_topProducts(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNProductList2ᚖgithubᚗcomᚋgnanasuriyanᚋgoᚑgraphqlᚋproductᚑmicroᚑserviceᚋgraphᚋmodelᚐProductList(ctx, field.Selections, res)
}
...
func (ec *executionContext) _ProductList(ctx context.Context, sel ast.SelectionSet, obj *model.ProductList) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "data":
			out.Values[i] = ec._ProductList_data(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				invalids++
			}
		default:
...
func (ec *executionContext) marshalNProduct2githubᚗcomᚋgnanasuriyanᚋgoᚑgraphqlᚋproductᚑmicroᚑserviceᚋgraphᚋmodelᚐProduct(ctx context.Context, sel ast.SelectionSet, v model.Product) graphql.Marshaler {
	return ec._Product(ctx, sel, &v)
}

func (ec *executionContext) marshalNProduct2ᚕᚖgithubᚗcomᚋgnanasuriyanᚋgoᚑgraphqlᚋproductᚑmicroᚑserviceᚋgraphᚋmodelᚐProductᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Product) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNProduct2ᚖgithubᚗcomᚋgnanasuriyanᚋgoᚑgraphqlᚋproductᚑmicroᚑserviceᚋgraphᚋmodelᚐProduct(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNProduct2ᚖgithubᚗcomᚋgnanasuriyanᚋgoᚑgraphqlᚋproductᚑmicroᚑserviceᚋgraphᚋmodelᚐProduct(ctx context.Context, sel ast.SelectionSet, v *model.Product) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
...
func (ec *executionContext) marshalNProductList2githubᚗcomᚋgnanasuriyanᚋgoᚑgraphqlᚋproductᚑmicroᚑserviceᚋgraphᚋmodelᚐProductList(ctx context.Context, sel ast.SelectionSet, v model.ProductList) graphql.Marshaler {
	return ec._ProductList(ctx, sel, &v)
}

func (ec *executionContext) marshalNProductList2ᚖgithubᚗcomᚋgnanasuriyanᚋgoᚑgraphqlᚋproductᚑmicroᚑserviceᚋgraphᚋmodelᚐProductList(ctx context.Context, sel ast.SelectionSet, v *model.ProductList) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
